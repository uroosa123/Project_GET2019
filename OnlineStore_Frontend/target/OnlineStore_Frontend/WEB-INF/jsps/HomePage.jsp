...
<h1 class="muted" style="text-align: center;font-family: verdana;color:lightgrey;font-family:cursive;font-style:italic;background-color:#000080;">${myData}</h1>
...
<table>
			<tr>
				<td><a href="viewProducts" style="color:white"><i class="icon-user brown"></i>View Products</a></td>
				<td></td>
