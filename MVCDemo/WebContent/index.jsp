...
<table>
			<tr>
				<td><a href="login.jsp" style="color:white"><i class="icon-user brown"></i>Log In</a></td>
				<td></td>
				<td><a href="Registeration.jsp" style="color:white"><i class="icon-edit icon-white"></i>Register</a></td>
			</tr>
		</table>
</div>
...
<div id="bs4-slide-carousel" class="carousel slide" data-ride="carousel" >
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="images\\images2.jpg" alt="Slide One">
      <
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="images\\new1.jpg" alt="Slide Two">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="images\\new2.jpg" alt="Slide Three">
    </div>
  </div>
